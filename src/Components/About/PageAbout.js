...
const PageAbout = () => {
  ...
  return (
    ...
    /> */}
          <img
            src={require("../../assets/bg-blue.jpg")}
            style={{
              height: 150,
              width: 150,
          ...
          <div className="container ">
            <div className="row align-items-center one">
              <div className="col-md-6 col-12 py-5 px-3 animate hook2 text ">
                <h2 className="text-light one">ABOUT US</h2>
                <p className="visible-text one">
                  <strong>
                  ...
                  <br />
                  <br />
                  At Roche Robots, we believe that robotics will improve
                  societal well-being and solve political and enviromental
                  issues. Robotics can change the world by manufacturing
                  abundance for all. Robots help bridge staff shortages 24 hours
                  a day, and are capable of providing real equality for future
                  generations. Perhaps the only way to survive political and
                  economic conflict is that government and economic policies are
                  placed in the hands of robots.
                  <br />
                  <br />
                ...
                <p className="hidden-text">
                  ...
                  temperature and blood pressure. We have security robots that
                  can patrol your buildings, and robots that can go into
                  elevators and deliver food, towels or mail to your room. Our
                  telepresence robots allow you to remotely inspect your
                  warehouses or factories. And our child care robots can read
                  you a story before bed, entertain your children with singing
                  and dancing, or act as a baby monitor when baby is sleeping.
                  Let our quality staff direct you to the choice that’s right
                  for you.
                  <br />
                  <br />
                  ...
                  closely with our clients to ensure they get the most out of
                  our robotic solutions. Our Company also offers training and
                  support services so our clients can get up to speed quickly
              ...
              <div className="col-md-6 col-12 animate hook4 ">
                <img
                  src={require("../../assets/standrobot123.png")}
                  alt=""
                  style={{ height: 380, marginLeft: 80 }}
                />
              </div>
              {/* <img src={require("../../assets/zags.png")} style={} alt="" /> */}
            </div>
            <div className="row align-items-center flex-row-reverse">
              <div
                className="col-md-6 col-12 py-5 px-3 animate hook2 text "
                style={{ color: "white" }}
              >
                <h2 style={{ color: "white" }}>OUR VISION</h2>
                <p className="visible-text " style={{ color: "white" }}>
                  Our vision at Roche Robots is to put robots into every corner
                  of Australia; homes, schools, offices, hospitals, aged care
                ...
                <p className="hidden-text" style={{ color: "white" }}>
                  ...
                  <br />
                  <br />
                  We also want to help people connect with each other, so we
                  will host events and workshops where people can share their
                  ...
                  <br />
                  <br />
                  We believe that robotics is the future of Australia, and we
                  are dedicated to making it a reality. Our team is passionate
                  about robotics, and we are committed to making our vision a
                  reality. We are working hard to develop innovative new robots
                  that can be used in various settings and applications. We hope
                  you will join us on this journey and help us make Australia a
                  world leader in robotics. If you want to learn more about
                  Roche Robots and our vision for the future, please visit our
    ...
    <div className="sec3 container-fluid">
      ...
      <div
        class="card border-light mb-3 bg-transparent opacity-90"
        style={{ maxWidth: 500 }}
      >
        ...
        >
          <div className="row">
            ...
            >
              <div className="card-header ">
                <span
                  ...
                  style={{ fontSize: "xx-large", color: "rgb(30, 189, 322)" }}
                >
                  group
                </span>
              </div>
              <div className="card-body">
                <h5 className="card-title owlu">Improving Education</h5>
            ...
            >
              ...
              <div className="card-body">
                <h5 className="card-title owlu">Improving Manufacturing</h5>
                <p className="card-text">
                  Robotics can help improve manufacturing processes, making them
                  faster, more accurate, and more efficient. Robotics can also
                  help reduce wastes and pollution.{" "}
                </p>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div className="card-body">
                <h5 className="card-title owlu">Enhancing Healthcare</h5>
                <p className="card-text">
                  Robotics can be used in various health care applications, from
                  assisting surgeons from surgery to providing patient
                  rehabilitation therapy. Robotics can help improve accuracy and
                  precision, as well as safety.
                </p>
              </div>
            ...
            >
              ...
              <div className="card-body">
                <h5 className="card-title owlu">Boosting The Economy</h5>
                <p className="card-text">
                  Robotics has the potential to create new jobs and businesses
                  and stimulate economic growth.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="card-body">
                <h5 className="card-title owlu">Enhancing Eco-Health</h5>
                <p className="card-text">
                  Robotics can be used in various ways to help protect the
                  enviroment, from monitoring and controlling pollution to
                  cleaning up hazardous waste sites.{" "}
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="card-body">
                <h5 className="card-title owlu">Improving Communication</h5>
                <p className="card-text">
                  Robotics can be used to develop new communication
                  technologies, including advanced prosthetic, brain-computer
                  interfaces, and human-robot interactions.
                </p>
              </div>
            </div>
            <img
        ...
        <div className="container-fluid sec4">
          <div className="container">
            <h3 className="one">
              ...
              reliable and effective robots that make your life easier.
              Regardless of the robot you want, we have a solution that will
              meet your needs.
            </h3>
          </div>
        </div>
