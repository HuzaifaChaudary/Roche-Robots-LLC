...
const Navbar = (props) => {
  ...
  return (
    <nav
      className={`navbar navbar-expand-lg navbar-dark text-light p-0 ${
        dis === 1 ? "pd" : ""
      }`}
      onMouseLeave={vanishCt}
    >
      <div className="container-fluid py-2 ">
        ...
        <div
          className="collapse navbar-collapse nav-menu py-2 "
        ...
        >
          <ul className={`navbar-nav justify-content-center  `}>
            <li
              onClick={displayNone}
              className="nav-item"
              style={{ "--i": " #c54040", "--j": "rgb(40, 100, 197)" }}
            >
              <span className="icon">
            ...
            <li
              onClick={displayNone}
              className="nav-item"
              style={{ "--i": "#ed4264", "--j": "#e1cb90" }}
            >
              <span className="icon">
                <i className="fa-solid fa-virus-covid"></i>
              </span>
              {/* <span className="title"><Link className="nav-link " aria-current="page" to="/covid">Covid-19 Robots</Link></span> */}
            </li>
            <li
              onClick={displayNone}
              className="nav-item"
